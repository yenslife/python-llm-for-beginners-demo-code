## Dify 工作流 (Workflow) 串接 Open WebUI Pipeline 腳本
...
class Pipeline:
    def __init__(self):
        self.name = "Open WebUI Memory test workflow"
        self.api_url = "http://host.docker.internal:80/v1/workflows/run"     # Set correct hostname
        self.api_key = "app-6CIBuaYDYiHCVV1w4ZA6F8nv"                              # Insert your actual API key here 
    ...
    def pipe(self, user_message: str, model_id: str, messages: List[dict], body: dict) -> Union[str, Generator, Iterator]:
        ...
        data = {
            "inputs": {"prompt": user_message + " " + str(messages) + "\nmodel id:" + model_id + "\nbody:" + str(body) + "\nchat_id:" + str(self.chat_id)},
